...
class VacinasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create vacina" do
    assert_difference("Vacina.count") do
      post vacinas_url, params: { vacina: { data_validade: @vacina.data_validade, nome_vacina: @vacina.nome_vacina, num_lote: @vacina.num_lote } }
    end
  ...
  test "should update vacina" do
    patch vacina_url(@vacina), params: { vacina: { data_validade: @vacina.data_validade, nome_vacina: @vacina.nome_vacina, num_lote: @vacina.num_lote } }
